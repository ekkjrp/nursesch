...
GRADE_ORDER = {"HN": 0, "CN": 1, "RN": 2, "AN": 3, "PN": 4}
...
def create_nurse(
    ...
    nurse = models.Nurse(
        ...
        dedicated_shift=body.dedicated_shift,
        weekday_preference=body.weekday_preference,
        weekend_preference=body.weekend_preference,
...
def update_nurse(
    ...
    if body.dedicated_shift != "":  # ""=not provided
        nurse.dedicated_shift = body.dedicated_shift
    if body.weekday_preference != "":
        nurse.weekday_preference = body.weekday_preference
    if body.weekend_preference != "":
        nurse.weekend_preference = body.weekend_preference
